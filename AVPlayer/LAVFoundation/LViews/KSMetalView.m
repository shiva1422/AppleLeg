...
+ (id)layerClass
{
  return [CAMetalLayer class];//instead of CALayer  metal layer backing  from core anim.
}
...
- (void)didMoveToSuperview
{
    ...
    if (self.superview)
    {
        ...
        [self.displayLink addToRunLoop:[NSRunLoop mainRunLoop] forMode:NSRunLoopCommonModes];//to keep draw in device sync
    }
    else
    {
